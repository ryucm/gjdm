            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">ETL 배치 등록</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                            	<form action="/gjdm/insertEtlBatch.do" method="post" class="insertForm">
	                            	<%-- <div>
		                            ...
		                            <div>
		                            	<label>
		                            		프로그램명
		                            		<input type="text" name="etlName" required>
		                            	</label>
		                            </div>
									<div>
		                            	<label>
		                            		비고
		                            		<input type="text" name="etlDesc" required>
		                            	</label>
		                            </div>
		                            	<input type="hidden" name="rgtrId" value="test">
		                            	<input type="hidden" name="updtId" value="test">
	                            	<button type="submit" class="etlbatchBtn">추가</button>
	                            </form>
                            </div>
                        </div>
                    </div>
